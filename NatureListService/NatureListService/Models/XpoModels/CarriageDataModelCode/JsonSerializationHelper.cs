...
namespace Microsoft.Extensions.DependencyInjection {
    public static class CarriageDataModelSystemTextJsonExtensions {
        public static IServiceCollection AddCarriageDataModelJsonOptions(this IServiceCollection builder) {
